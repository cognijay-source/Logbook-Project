    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <div className="ml-3">
            <Button asChild size="sm" className="bg-gradient-to-r from-sky-600 to-cyan-500 text-white shadow-md shadow-sky-500/20 hover:from-sky-500 hover:to-cyan-400 hover:shadow-lg">
            ...
            <div className="mt-8 flex flex-col gap-1">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="rounded-md px-3 py-2.5 text-base font-medium text-foreground transition-colors duration-200 hover:bg-muted"
                >
                  {link.label}
                </Link>
              ))}
              ...
              <div className="mt-4 px-3">
                <Button asChild className="w-full bg-gradient-to-r from-sky-600 to-cyan-500 text-white">
