    ...
    >
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6 lg:px-8">
        <Link href="/" className="group flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#00d4aa] shadow-md shadow-[#00d4aa]/20 transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-[#00d4aa]/30">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <div className="ml-3">
            <Button
              asChild
              size="sm"
              className="bg-[#00d4aa] text-[#0a0a0f] font-semibold shadow-md shadow-[#00d4aa]/20 hover:bg-[#00e8bb] hover:shadow-lg hover:shadow-[#00d4aa]/30"
            >
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-72 border-white/[0.06] bg-[#12121a]">
            ...
            <div className="mt-8 flex flex-col gap-1">
              ...
              <div className="mt-4 px-3">
                <Button
                  asChild
                  className="w-full bg-[#00d4aa] text-[#0a0a0f] font-semibold hover:bg-[#00e8bb]"
                >
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-2.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-md bg-[#00d4aa] shadow-sm">
